...
const createChart2 = (id, XLabels, dataset, dataset2, title, legendLabel, legendLabel2, xtitle, ytitle) => {
    let myChart = new Chart(id, {
        type: 'bar',
        data: {
            labels: XLabels,
            datasets: [{
                ...
                label: legendLabel2,
                data: dataset2,
                backgroundColor: 'rgba(255, 145, 145, 0.3)',
                borderColor: 'rgba(255, 145, 145, 1)',
                borderWidth: 2
            }]
        },
        options: {
...
const updateChart2 = (chart, XLabels, dataset, dataset2) => {
    chart.data.labels = XLabels;
    chart.data.datasets[0].data = dataset;
