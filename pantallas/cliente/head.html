<header class="header-clientes">
    ...
    <div class="carrito-button">
        <a class="links-image" href="carrito.php"><img src="../../images/noun_Shopping Bag_2425846.svg" alt="imgProducto" width="60" height="60">CARRITO
        <div class="cant-compras">0</div></a>
    </div>
</header>